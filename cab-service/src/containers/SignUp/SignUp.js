                                ...
                                <CardBody>
                                    <form>
                                        ...
                                        <div className="grey-text">
                                            <Input label="Your name" icon="user"  type="text"  validate error="wrong" success="right" />
                                            <Input label="Your email" icon="envelope"  type="email" validate error="wrong" success="right" />
